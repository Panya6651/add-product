                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="card h-100">
                            <img src="./assets/imgs/<?= htmlspecialchars($row['image']); ?>" class="card-img-top"
                                alt="<?= htmlspecialchars($row['name']); ?>" style="object-fit:cover; height:200px;">
                            <div class="card-body">
                                <h5 class="card-title"><?= htmlspecialchars($row['name']); ?></h5>
                                <p class="card-text"><?= htmlspecialchars($row['description']); ?></p>
                                <p class="card-text"><strong>ราคา:</strong> <?= htmlspecialchars($row['price']); ?> บาท
                                </p>
                                <p class="card-text"><strong>เพิ่มเมื่อ:</strong>
